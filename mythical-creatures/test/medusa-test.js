...
describe('Medusa', function() {
  ...
  it('should have a name', function() {
    var jeff = new Medusa('Jeff')// instantiate a Medusa object with your name as an argument
    var garg = new Medusa('Gargamel')// instantiate another Medusa object with someone else's name as an argument

    assert.equal(jeff.name, 'Jeff');// assert that the first medusa's name is your name
    assert.equal(garg.name, 'Gargamel');// assert that the second medusa's name is the other name
